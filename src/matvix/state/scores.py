...
AXIS_COMPONENTS: dict[str, list[tuple[str, str, float, str]]] = {
    ...
    "persistence": [
        ("persistence.fvol_30_93", "p_fvol_30_93", 0.40, "fvol_30_93"),
        ("persistence.fvol_93_184", "p_fvol_93_184", 0.30, "fvol_93_184"),
        (
            "persistence.fvol_change_5d",
            "p_d5_fvol_30_93",
            0.20,
            "d5_fvol_30_93",
        ),
        (
            "persistence.curve_breadth",
